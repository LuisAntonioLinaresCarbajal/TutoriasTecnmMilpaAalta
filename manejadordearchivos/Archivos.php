...
<head>
	...
	<style>
		...
		@media screen and (max-width: 800px) {
			/** falta hacer responsive esta parte meter las clases necesarias con sus medidas */
...
<body>
	...
	<div id="top">
		...
		<div class="Homeicon">
			<a href="../dashboard.php" class="social-media-icon3">
				<i class='bx bx-home'></i>
			</a>

		</div>
		<a class="social-media-icon3">inicio</a>
